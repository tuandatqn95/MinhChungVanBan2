...
<script>
	...
	$(document)
			.ready(
					function() {
						document.getElementsByClassName("Editor-editor")[0].innerHTML = document
								.getElementById("NoiDung").value;
					});
...
<%
	...
	if (request.getParameter("id") != null) {
		idThongBao = Integer.parseInt(request.getParameter("id"));
		thongBao = thongBaoDAO.GetThongBaoByID(idThongBao);
	}
	if (thongBao == null) {
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control" name="TieuDe"
													placeholder="Tiêu đề..." value="<%=thongBao.getTieuDe()%>">
											</div>
										</div>
										<div class="form-group">
