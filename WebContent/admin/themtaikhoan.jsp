							...
							<div class="row">
								<div class="col-lg-12">
									<form action="TaiKhoanServlet" method="post"
										...
										<div class="form-group">
											<label class="control-label col-sm-2" for="pwd">Nhập
												lại mật khẩu:</label>
											<div class="col-sm-10">
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<label class="radio-inline"> <input name="GioiTinh"
													id="optionsRadiosInline1" value="Nam" type="radio">Nam
												</label> <label class="radio-inline"> <input name="GioiTinh"
													id="optionsRadiosInline2" value="Nu" type="radio">Nữ
												</label>
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<select class="form-control" name="IDLoaiTaiKhoan">
													...
													%>
													<option value="<%=ltk.getID()%>"><%=ltk.getTenLoaiTaiKhoan()%></option>
													<%
														}
													%>
												</select>
